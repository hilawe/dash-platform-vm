...
| D-22 | The candidate set clearing the screen is CosmWasm and MoveVM, plus the two charter control arms | ACCEPTED (screen, 2026-08-30) | ASSERTED for Move, EXECUTION-PRODUCED for CosmWasm. A ranking of who deserves evidence next, not a measurement | The zero-knowledge engines being screened, or evidence produced against Move |
